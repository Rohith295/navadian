            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="text-muted-foreground">
                  By accessing and using navadian, you accept and agree to be bound by the terms 
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Permission is granted to temporarily access navadian for personal, 
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  You may not use navadian for any unlawful purpose or to solicit others 
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  In no event shall navadian or its suppliers be liable for any damages 
